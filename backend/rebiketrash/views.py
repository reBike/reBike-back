...
from .serializers import TrashImageSerializer, TrashImageDetailSerializer, TrashImageStatisticsSerializer, ChallengeSerializer, UserChallengeSerializer
...
class UploadImage(APIView):
    def post(self, request, user_id):
        ...
        return JsonResponse({'image_id':image_info.trash_image_id,'challenge':challenge_id, 'challenge_content':challenge_content})
